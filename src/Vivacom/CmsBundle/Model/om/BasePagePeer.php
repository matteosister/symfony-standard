...
use \PropelException;
use \PropelPDO;
use Vivacom\CmsBundle\Model\Page;
use Vivacom\CmsBundle\Model\PagePeer;
use Vivacom\CmsBundle\Model\map\PageTableMap;
...
abstract class BasePagePeer {
	...
	const OM_CLASS = 'Vivacom\\CmsBundle\\Model\\Page';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'media.Dati.internet.sf2.src.Vivacom.CmsBundle.Model.Page';
